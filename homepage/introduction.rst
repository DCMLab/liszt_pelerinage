...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/liszt_pelerinage.git
...
* `Franz Liszt – Années de Pèlerinage <https://github.com/DCMLab/liszt_pelerinage/archive/refs/heads/main.zip>`__
...
-  ``MS3/160.01_Chapelle_de_Guillaume_Tell.mscx``: Uncompressed MuseScore file including the music and annotation labels.
-  ``notes/160.01_Chapelle_de_Guillaume_Tell.tsv``: A table of all note heads contained in the score and their relevant features (not each of them represents an onset, some are tied together)
-  ``measures/160.01_Chapelle_de_Guillaume_Tell.tsv``: A table with relevant information about the measures in the score.
-  ``harmonies/160.01_Chapelle_de_Guillaume_Tell.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/160.01_Chapelle_de_Guillaume_Tell.tsv')
   notes = ms3.load_tsv('notes/160.01_Chapelle_de_Guillaume_Tell.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/liszt_pelerinage/issues>`__ and feel free to fork and submit pull requests.
