...
[this ZIP file](https://github.com/DCMLab/liszt_pelerinage/archive/refs/heads/main.zip).
...
* `harmonies/160.01_Chapelle_de_Guillaume_Tell.tsv`: A list of the included harmony labels (including cadences and phrases) with their positions in
  the score.
...
The file names listed in the [Overview](#overview) below refer to:

* S. 160: Années de pèlerinage: Première année (Suisse)
* S. 161: Années de pèlerinage: Deuxieme Année (Italie)
...
|162.02_Canzone                                                           |      60|    98|2.3.0   |AN                                       |AB                                                     |
